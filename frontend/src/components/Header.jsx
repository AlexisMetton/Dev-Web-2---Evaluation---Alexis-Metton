...
<nav
  ...
  } lg:flex lg:flex-row lg:space-x-4 absolute lg:relative top-full left-0 w-full bg-${theme === "dark" ? "black" : "white"} shadow-md lg:shadow-none`}
>
            {isAuthenticated ? (
              <>
                <Link
          ...
          <label className="theme">
            ...
            <svg className="icon icon-moon" viewBox="0 0 24 24" style={{fill: "black"}}>
